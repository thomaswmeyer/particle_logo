...
// No revision in the banner: dist/ is built from the working tree and
// committed with it, so the commit that carries a build is the one it is
// from; a consumer's package.json pin names it.
const banner = '// particle_logo, generated by scripts/build.js from src/: do not edit.\n';
